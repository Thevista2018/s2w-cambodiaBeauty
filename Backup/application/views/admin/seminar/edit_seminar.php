    ...
    <div id="body_box">
        ...
        <form method="POST" enctype="multipart/form-data" action="">
            ...
            <input type="hidden" name="seminar_pic" value="<?=$data['seminar_pic'];?>" />
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <img src="<?php echo $thumb; ?>" onerror="handleImgError(this, 'seminar', 68)" />
                            </td>
                        </tr>
...
<?php session_start(); $_SESSION['ckfinder_baseUrl'] = BASE_HREF.'/uploads/img_ckfinder/seminar/'; ?>
