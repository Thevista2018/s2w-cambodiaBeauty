    ...
    <div id="body_box">
        ...
        <div id="top_box" style="width:960px; margin:10px auto 10px auto;">
            <!-- Button : เพิ่มรายการ -->
            <input type="button" name="bt_add" id="bt_add" value="เพิ่ม Shortnews" class="button grey add" onclick="redirect('<?=BASE_AM;?>/shortnews/add_shortnews')" />
        </div>
        <!-- End : Add -->
            ...
            <table width="960" class="tb_style1" id="strip">
                ...
                <thead>
                    <tr>
                        ...
                        <th width="700"><span>รายการ Shortnews</span></th>
                ...
                <tbody>
                    <?php
                        ...
                        foreach ($list['data'] as $content) {
                            ...
                            $short_link = $content['short_link'];
                            $status_usage = $content['short_status'];
                    ...
                    <tr>
                        ...
                        <td class="pad-top-10" style="padding-bottom:10px;">
                            ...
                            <div class="line-detail">
                                ...
                                <span class="user_code" style="text-align:left; width:580px; padding-bottom:3px;"><?=$short_title;?></span>
                            </div>
                        ...
                        <td id="result_<?php echo $id; ?>" style="font-size:0;">
                            <img src="<?php echo $img_yes; ?>" class="tooltip cursor status_y" onclick="updateStatus('<?php echo $id; ?>', 1, 'shortnews')" title="เปิด" />
                            <img src="<?php echo $img_no; ?>" class="tooltip cursor status_n" onclick="updateStatus('<?php echo $id; ?>', 0, 'shortnews')" title="ปิด" />
                        </td>      
                        ...
                        <td style="vertical-align:middle; padding:12px 0;">
                            ...
                            <div class="icon_box" style="padding-top:0;">
                                <a href="<?=BASE_AM;?>/shortnews/edit_shortnews?short_id=<?php echo $id; ?>" title="แก้ไข" class="cursor tooltip edit">: แก้ไข</a>
                            </div>

                            <!-- Delete -->
                            <div class="icon_box">
                                <span title="ลบ" class="cursor tooltip del" onclick="delete_id(<?php echo $id; ?>, 'shortnews');">: ลบ</span>
                            </div>
                        </td>
