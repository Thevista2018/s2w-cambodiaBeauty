                ...
                <table class="tb_form">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php $thumb = $this->f_lib->getPathFolder($data['download_id'], $data['download_pic'], 'uploads/download'); ?>
                                <img src="<?=$thumb;?>" />
                            </td>
                        </tr>
                        <!-- End : รูป -->
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="download_title" id="download_link" value="<?=$data['download_title'];?>" class="style_1" />
                                <p class="star">*</p>
