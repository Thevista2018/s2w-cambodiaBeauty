            ...
            <table width="960" class="tb_style1" id="strip">
                ...
                <thead>
                    <tr>
                        ...
                        <th width="700"><span>รายการ Publicities</span></th>
                ...
                <tbody>
                    <?php
                        ...
                        foreach ($list['data'] as $content) {
                            ...
                            $publicities_desc = $content['publicities_desc'];
                            $publicities_file = $content['publicities_file'];
                    ...
                    <tr>
                        ...
                        <td class="pad-top-10" style="padding-bottom:10px;">
                            ...
                            <div class="line-detail">
                                ...
                                <span class="user_code"><?=$publicities_title;?></span>
                            </div>
                            ...
                            <div class="line-detail">
                                ...
                                <span class="colon">:</span>
                                <span class="user_code" style="color:green;"><?=$publicities_file;?></span>
                            </div>
                            <div class="clear-float"></div>
                        ...
                        <td style="vertical-align:middle; padding:12px 0;">
                            ...
                            <div class="icon_box" style="padding-top:0;">
                                <a href="<?=BASE_AM;?>/publicities/edit_publicities?publicities_id=<?php echo $id; ?>" title="แก้ไข" class="cursor tooltip edit">: แก้ไข</a>
                            </div>

                            <!-- Delete -->
                            <div class="icon_box">
                                <span title="ลบ" class="cursor tooltip del" onclick="delete_id(<?php echo $id; ?>, 'publicities');">: ลบ</span>
                            </div>
                        </td>
