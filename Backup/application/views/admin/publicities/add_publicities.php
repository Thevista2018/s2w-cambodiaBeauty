                ...
                <table class="tb_form">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="publicities_date" id="publicities_date" value="<?=$data['publicities_date'];?>" class="style_1" style="width: 180px;" />
                                <p class="star">*</p>
...
<?php session_start(); $_SESSION['ckfinder_baseUrl'] = '/uploads/img_ckfinder/publicities/'; ?>
