    ...
    <div id="body_box">
        ...
        <div id="top_box" style="width:960px; margin:10px auto 10px auto;">
            <!-- Button : เพิ่มรายการ -->
            <input type="button" name="bt_add" id="bt_add" value="เพิ่ม Publicities" class="button grey add" onclick="redirect('<?=BASE_AM;?>/publicities/add_publicities')" />
        </div>
        <!-- End : Add -->
            ...
            <table width="960" class="tb_style1" id="strip">
                ...
                <thead>
                    <tr>
                        ...
                        <th width="580"><span>รายการPublicities</span></th>
                ...
                <tbody>
                    <?php
                        ...
                        foreach ($list['data'] as $content) {
                            $id = $content['publicities_id'];
                            $publicities_title = $content['publicities_title'];
                            $status_usage = $content['publicities_status'];
                            ...
                            /* -- thumb -- */
//                            $thumb = $this->f_lib->getPathFolder($content['publicities_id'], $content['publicities_pic'], 'uploads/publicities');
                            $thumb = $this->f_lib->getPath($content['publicities_id'], $content['publicities_pic'], 'uploads/publicities', 'default.jpg');
                    ?>
                    <tr>
                        <!-- ///////////////////////////////////////////////////// ลำดับที่ ///////////////////////////////////////////////////// -->
                        <td>
                        ...
                        <td class="pad-top-10" style="padding-bottom:10px;">
                            ...
                            <div class="line-detail">
                                ...
                                <span class="user_code" style="color:green;"><?=$publicities_title;?></span>
                            </div>
                        ...
                        <td id="result_<?php echo $id; ?>" style="font-size:0;">
                            <img src="<?php echo $img_yes; ?>" class="tooltip cursor status_y" onclick="updateStatus('<?php echo $id; ?>', 1, 'publicities')" title="เปิด" />
                            <img src="<?php echo $img_no; ?>" class="tooltip cursor status_n" onclick="updateStatus('<?php echo $id; ?>', 0, 'publicities')" title="ปิด" />
                        </td>
                        ...
                        <td style="vertical-align:middle; padding:12px 0;">
                            ...
                            <div class="icon_box" style="padding-top:0;">
                                <a href="<?=BASE_AM;?>/publicities/edit_publicities?publicities_id=<?=$id;?>" title="แก้ไข" class="cursor tooltip edit">: แก้ไข</a>
                            </div>

                            <!-- Delete -->
                            <div class="icon_box">
                                <span title="ลบ" class="cursor tooltip del" onclick="delete_id(<?=$id;?>, 'publicities');">: ลบ</span>
                            </div>
                        </td>
