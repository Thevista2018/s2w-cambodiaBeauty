...
//if ($_SERVER['HTTP_HOST']==SERV_NAME)
    $active_group = 'server';
else
...
$db['default']['username'] = 'myanmarbuilddeco';
$db['default']['password'] = 'kiuytdokjgbbbxxx';
$db['default']['database'] = 'myanmarbuilddecor';
...
$db['server']['username'] = 'myanmarbuilddeco';
$db['server']['password'] = 'kiuytdokjgbbbxxx';
$db['server']['database'] = 'myanmarbuilddecor';
