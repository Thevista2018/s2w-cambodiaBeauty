...
if(isset($listdata) && count($listdata) != 0){
  foreach ($listdata as $key => $value) {
    $Id = $value['know_id'];
    $Text_titleEN = $value['know_title_en'];
    $File_imagesEN = $value['know_images_en'];
    $Text_detailEN = $value['know_detail_en'];
    $Text_titleTH = $value['know_title_th'];
    $File_imagesTH = $value['know_images_th'];
    $Text_detailTH = $value['know_detail_th'];
    $Text_eye = $value['know_show'];
    $Text_check = $value['know_status'];
  }
  $TitlePage = "Update";
  $actionUrl = site_url('article/knowledge/update');
}else{
  $TitlePage = "Create";
  $actionUrl = site_url('article/knowledge/create');
  $Text_eye = 1;
  $Text_check = 1;
}
?>
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?=site_url('article/knowledge/index');?>">Knowledge</a>
            </li>
            <li class="active">
              ...
              <div class="tabs-container">
                  ...
                  <div class="mail-tools tooltip-demo">
                        <div class="btn-group pull-right">
                          ...
                          <?PHP if(!empty($Id)){ ?>
                          <button class="btn btn-white btn-sm Btn-delete" data-url="<?=site_url('article/knowledge/delete/'.$Id);?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Move to trash"><i class="fa fa-trash-o"></i> </button>
                          <?PHP }?>
                          <?PHP if(!empty($Id)){ ?>
                          <button class="btn btn-warning btn-sm Btn-url" data-url="<?=site_url('knowledge/detail/'.$Id);?>" data-toggle="tooltip" data-placement="left" title="" data-original-title="Preview this pages"><i class="fa fa-search"></i> Preview</button>
                          <?PHP }?>
                        </div>
                    </div>
                        </ul>
                            ...
                            <div id="tab-1" class="tab-pane <?PHP if($lg == 'english'){echo 'active';}?>">
                                <div class="panel-body">
                                    <form action="<?=$actionUrl."/en";?>" method="post" enctype="multipart/form-data" name="formNewsEN_<?=$TitlePage;?>" id="formNewsEN_<?=$TitlePage;?>" class="form-horizontal" novalidate>
                                      <input type="hidden" name="crfknowledge" id="crfknowledge" value="<?=$crfknowledge;?>">
                                      ...
                                      <div class="form-group">
                                        <div class="col-sm-6 col-sm-offset-4">
                                            <a href="<?=site_url('article/knowledge/index');?>">
