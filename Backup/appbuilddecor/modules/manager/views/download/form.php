                                ...
                                <div class="panel-body">
                                  <form action="<?=$actionUrl;?>" method="post" enctype="multipart/form-data" name="formDownload_<?=$TitlePage?>" id="formDownload_<?=$TitlePage?>" class="form-horizontal" novalidate>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                          <textarea rows="25" cols="150" class="summernote" id="Text_detail" data-img="<?=site_url('manager/filemanager/summernote');?>" name="Text_detail"><?PHP if(isset($Text_detail)){echo $Text_detail;}?></textarea>
                                        </div>
                                    </div>
