...
<meta name="keywords" content="Myanmar Event Park Yangon, Myanmar" />
<meta name="title" content="Myanmar Event Park Yangon, Myanmar" />
<meta name="description" content="Myanmar Event Park Yangon, Myanmar" />
			...
			<!-- BEGIN HEADER -->
				<div id="header">
					...
					<div id="topmenu">
						<div id="navigation">
							<ul id="nav">
								<li class="noborder"><a href="index.php">Home</a></li>
								<li><a href="#">About the Show</a>
									<ul>
										<li><a href="About_Myanmar.php">About Myanmar</a></li>
										<li><a href="Industry_ataglance.php">Industry at a glance</a></li>
