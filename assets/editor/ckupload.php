<? 
	...
	echo "<script type='text/javascript'>window.parent.CKEDITOR.tools.callFunction($funcNum, 'http://www.cambodiaarchitectdecor.com/assets/editor/$url', '$message');</script>";
