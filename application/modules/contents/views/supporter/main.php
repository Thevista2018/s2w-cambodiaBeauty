      ...
      <div class="ibox float-e-margins">
          <div class="ibox-content">
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <a href="<?=site_url('contents/supporter/form');?>">
                    <button class="btn btn-w-m btn-primary btn-sm pull-right">Add Supporter</button>
                  </a>
              ...
              <div class="table-responsive">
                ...
                <table class="table table-striped table-hover dataTables-example" >
                  ...
                  foreach ($listdata as $key => $value) {
                      $Valuepage = $value['supporter_title'];
                  ?>
                  <tr class="gradeX">
                      <td><strong><?="P".str_pad($value['supporter_id'],5,"0",STR_PAD_LEFT);?></strong></td>
                      <td class="project-title"><?=$value['supporter_title'];?> <?=$value['supporter_title2'];?></td>
                      <td style="text-align: center;"><?=$value['supporter_sort'];?></td>
                      <td class="center">
                        <?=$value['supporter_editby'];?><br />
                        <small class="text-muted"><i class="fa fa-clock-o"></i> <?=date('d M Y h:i A', strtotime($value['supporter_lastedit']));?></small>
                      </td>
                      <td class="center">
                        <div class="btn-group">
